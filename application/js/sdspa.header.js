...
sdspa.header = (function () {
    ...
    var
        ...
        staticConfigurationMap = {
            ...
            main_html : String() +
              '<div class="sdspa-shell-header-name">STEPHEN DYKSEN</div>' +
              '<div class="sdspa-shell-header-navcontainer">' +
                '<nav class="sdspa-shell-header-navcontainer-mainnav nav-link-rolling-effect">' +
				        ...
				        '</nav>' +
                // '<nav class="sdspa-shell-header-navcontainer-writingnav">' +
					      //   '<a href="#"><span data-hover="BIO">BIO</span></a>' +
					      //   '<a href="#"><span data-hover="PROJECTS">PROJECTS</span></a>' +
					      //   '<a href="#"><span data-hover="WRITINGS">WRITINGS</span></a>' +
				        // '</nav>' +
